...
int main()
{
   ...
   char userChoice;
   std::cout << "Enter 'R' to test the recurrsive link-based implementation\n"
   << " or 'L' to test the link-based implementation: ";
   std::cin >> userChoice;
   if (toupper(userChoice) == 'R')
   {
      bagPtr = new LinkedBagRecursive<std::string>();
      std::cout << "Testing the Recursive Link-Based Bag:" << std::endl;
   }
   else
   {
